...
<body>
  ...
  <header id="header">
	...
	<form id="labnol1" method="post" action="/voicecontrollehotel">
		{{ csrf_field() }}
  <div class="speech">
    <input type="text" name="q" id="transcript" placeholder="search Hotel by City" class="typeahead form-control" />
  ...
  <form id="labnol2" method="post" action="/voicecontrolleflight">
    {{ csrf_field() }}
  <div class="speech">
    <input type="text" name="f" id="transcript1" placeholder="search Flight by flight name" class="typeahead form-control" />
